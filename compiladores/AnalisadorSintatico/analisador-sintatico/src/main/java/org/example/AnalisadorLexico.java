...
void programa() throws ParseException {
  ...
  static final public void opcional_id() throws ParseException {
  ...
  static final public void opcional_def() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DEFINE:{
  ...
  static final public void declaracao_de_variaveis() throws ParseException {
  ...
  static final public void declaracao_de_variaveis_aux() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IGUAL:{
  ...
  static final public void declaracao_de_variaveis_aux2() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IGUAL:{
      jj_consume_token(IGUAL);
  ...
  static final public void lista_de_identificadores_aux() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VIRGULA:{
  ...
  static final public void valores_aux() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VIRGULA:{
      jj_consume_token(VIRGULA);
      valores();
  ...
  static final public void lista_de_comandos_aux() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SET:
    case READ:
    case SHOW:
  ...
  static final public void comando_atribuicao_aux() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IGUAL:{
      jj_consume_token(IGUAL);
      expressao();
  ...
  static final public void comando_entrada_dados() throws ParseException {
  ...
  static final public void cmd_dados() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  static final public void comando_saida_dados() throws ParseException {
  ...
  static final public void lista_id_const() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CONSTANTE_INTEIRA:
    case CONSTANTE_REAL:
    case CONSTANTE_LITERAL:{
  ...
  static final public void comando_selecao() throws ParseException {
    jj_consume_token(IF);
    expressao();
  ...
  static final public void comando_repeticao() throws ParseException {
  ...
  static final public void expressao_aux() throws ParseException {
    expressao_arit();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IGUAL:
    case DIFERENTE:
  ...
  static final public void expressao_arit() throws ParseException {
    termo2();
    menor_prioridade();
}

  static final public void menor_prioridade() throws ParseException {
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case MAIS:
  ...
  static final public void media_prioridade() throws ParseException {
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case VEZES:
  ...
  static final public void skipUntil(int[] syncTokens) throws ParseException {Token t; int k=0;
while (true) {
      t = getToken(1);
  ...
  static final public void reportParseError(ParseException e) throws ParseException {
