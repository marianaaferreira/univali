...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ackni\OneDrive\Documentos\Code\univali\introdução à programação em python\pythonProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ackni\OneDrive\Documentos\Code\univali\introdução à programação em python\pythonProject\Scripts\deactivate.nu'
